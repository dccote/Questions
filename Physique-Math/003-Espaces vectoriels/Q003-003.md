...
La série de polynôme $\left\{ 1,x,\frac{1}{2}(3x^2-1), \frac{1}{2}(5x^3-3x), .... \right\}$ s'appelle les polynômes de Legendre et forme une base orthogonale pour les fonctions polynomiales.